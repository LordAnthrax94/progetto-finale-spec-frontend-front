    ...
    <div>
      ...
      <div className='flex flex-wrap justify-between'>
          {sortedVideogames.map((videogame) => {            
            ...
            return (
              <div key={videogame.id} className="min-w-sm bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 mt-5">
                      ...
                      : (
                        <div className="flex flex-wrap justify-center w-full">
                          {filteredVideogames.map(videogame => (
                            <div key={videogame.id} className="min-w-sm bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 mt-5 mx-2">
                              <img className="w-full h-48 object-cover" src={`/img/${videogame.imageUrl}`} alt={videogame.title} />
                              <div className="p-4">
